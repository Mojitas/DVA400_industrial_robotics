...
%==========================================================================
%
% Goal: Obtain the symbolic expression of a polynomial that envisages the following symbolic variables:
%
% Value variables: 
...
% Initialize symbolics variables for cubic polynomial
